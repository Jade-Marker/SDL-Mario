...
CharacterMario::CharacterMario(SDL_Renderer* renderer, std::string imagePath, Vector2D startPosition, int jumpKey, int rightKey, int leftKey,
    ...
    int jumpFrameCount, int jumpStartFrame, int moveFrameCount, int moveStartFrame, int idleFrameCount, int idleStartFrame, bool screenWrappingEnabled):
    CharacterPlayable(renderer, imagePath, startPosition, jumpKey, rightKey, leftKey,
        ...
        jumpFrameCount, jumpStartFrame, moveFrameCount, moveStartFrame, idleFrameCount, idleStartFrame, screenWrappingEnabled)
{
}
